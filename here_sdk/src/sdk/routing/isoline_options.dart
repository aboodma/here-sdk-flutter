...
class IsolineOptionsCalculation {
  ...
  factory IsolineOptionsCalculation(IsolineRangeType rangeType, List<int> rangeValues, IsolineCalculationMode isolineCalculationMode, int? maxPoints) => $prototype.$init(rangeType, rangeValues, isolineCalculationMode, maxPoints);
...
class IsolineOptionsCalculation$Impl {
  IsolineOptionsCalculation $init(IsolineRangeType rangeType, List<int> rangeValues, IsolineCalculationMode isolineCalculationMode, int? maxPoints) {
    final _$initFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Int32, Uint32, Pointer<Void>, Uint32, Pointer<Void>), Pointer<Void> Function(int, int, Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_routing_IsolineOptions_Calculation_make__IsolineRangeType_ListOf_Int_IsolineCalculationMode_Int_'));
