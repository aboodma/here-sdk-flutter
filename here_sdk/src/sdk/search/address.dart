...
class Address {
  ...
  Address._(this.city, this.countryCode, this.country, this.district, this.subdistrict, this.houseNumOrName, this.postalCode, this.state, this.county, this.street, this.block, this.subBlock, this.addressText, this.type);
  /// Default constructor.
  /// Note: Sets all the string values to "".
  Address()
      : city = "", countryCode = "", country = "", district = "", subdistrict = "", houseNumOrName = "", postalCode = "", state = "", county = "", street = "", block = "", subBlock = "", addressText = "", type = null;
...
Pointer<Void> sdkSearchAddressToFfi(Address value) {
  ...
  final _result = _sdkSearchAddressCreateHandle(_cityHandle, _countryCodeHandle, _countryHandle, _districtHandle, _subdistrictHandle, _houseNumOrNameHandle, _postalCodeHandle, _stateHandle, _countyHandle, _streetHandle, _blockHandle, _subBlockHandle, _addressTextHandle, _typeHandle);
