...
class SegmentReference {
  ...
  SegmentReference([String segmentId = "", TravelDirection travelDirection = TravelDirection.bidirectional, double offsetStart = 0.0, double offsetEnd = 1.0, int tilePartitionId = 0, int? localId = 0])
    : segmentId = segmentId, travelDirection = travelDirection, internaloffsetStart = offsetStart, internaloffsetEnd = offsetEnd, tilePartitionId = tilePartitionId, localId = localId;
  SegmentReference.withDefaults()
      : segmentId = "", travelDirection = TravelDirection.bidirectional, internaloffsetStart = 0.0, internaloffsetEnd = 1.0, tilePartitionId = 0, localId = 0;
