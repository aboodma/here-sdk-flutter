...
class LocationInternal {
  ...
  /// If it cannot be determined, the value is `null`.
  @Deprecated("Will be removed in v4.13.0. Use [Location.timestampSinceBoot] instead.")
  ...
  /// [timestampSinceBootInMilliseconds] The time in milliseconds at which the location was determined, relative to device
  /// boot time. This time is monotonic and not affected by leap time or other system
  /// time adjustments, so this is the recommended basis for general purpose interval timing
  /// between location updates.
  /// If it cannot be determined, the value is `null`.
  ...
  LocationInternal(this.coordinates, this.bearingInDegrees, this.speedInMetersPerSecond, this.time, this.horizontalAccuracyInMeters, this.verticalAccuracyInMeters, this.bearingAccuracyInDegrees, this.speedAccuracyInMetersPerSecond, this.timestampSinceBootInMilliseconds, this.timestampSinceBoot, this.locationTechnology, this.gnssTime);
  LocationInternal.withDefaults(GeoCoordinates coordinates)
    : coordinates = coordinates, bearingInDegrees = null, speedInMetersPerSecond = null, time = null, horizontalAccuracyInMeters = null, verticalAccuracyInMeters = null, bearingAccuracyInDegrees = null, speedAccuracyInMetersPerSecond = null, timestampSinceBootInMilliseconds = null, timestampSinceBoot = null, locationTechnology = null, gnssTime = null;
}
