...
class TrafficSpeed {
  ...
  TrafficSpeed(double? baseSpeedInMetersPerSecond, double? trafficSpeedInMetersPerSecond, double? jamFactor)
    : offset = 0, baseSpeedInMetersPerSecond = baseSpeedInMetersPerSecond, trafficSpeedInMetersPerSecond = trafficSpeedInMetersPerSecond, jamFactor = jamFactor;
  @override
