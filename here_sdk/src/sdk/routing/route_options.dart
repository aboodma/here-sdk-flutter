...
class RouteOptions {
  ...
  /// A flag that indicates whether the order of waypoints that is passed to [RoutingInterface.calculateBusRoute] should be optimized in the best order.
  /// The best order is calculated by the same metrics that are used during regular calculation, e.g. [OptimizationMode].
  /// The starting [Waypoint] and the end one are not reordered.
  /// If the whole number of waypoints is fewer than 4 - the flag doesn't affect the result route (nothing to optimize).
  /// The result order of waypoints can be deduced by waypoint indices in route sections
  ...
  RouteOptions([OptimizationMode optimizationMode = OptimizationMode.fastest, int alternatives = 0, DateTime? departureTime = null, DateTime? arrivalTime = null, double? speedCapInMetersPerSecond = null, bool enableRouteHandle = false, bool enableTrafficOptimization = true, bool enableTolls = false, int occupantsNumber = 1, bool optimizeWaypointsOrder = false])
    : optimizationMode = optimizationMode, alternatives = alternatives, departureTime = departureTime, arrivalTime = arrivalTime, speedCapInMetersPerSecond = speedCapInMetersPerSecond, enableRouteHandle = enableRouteHandle, enableTrafficOptimization = enableTrafficOptimization, enableTolls = enableTolls, occupantsNumber = occupantsNumber, optimizeWaypointsOrder = optimizeWaypointsOrder;
  RouteOptions.withDefaults()
      : optimizationMode = OptimizationMode.fastest, alternatives = 0, departureTime = null, arrivalTime = null, speedCapInMetersPerSecond = null, enableRouteHandle = false, enableTrafficOptimization = true, enableTolls = false, occupantsNumber = 1, optimizeWaypointsOrder = false;
  @override
...
final _sdkRoutingRouteoptionsCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Uint32, Int32, Pointer<Void>, Pointer<Void>, Pointer<Void>, Uint8, Uint8, Uint8, Int32, Uint8),
...
Pointer<Void> sdkRoutingRouteoptionsToFfi(RouteOptions value) {
  ...
  final _result = _sdkRoutingRouteoptionsCreateHandle(_optimizationModeHandle, _alternativesHandle, _departureTimeHandle, _arrivalTimeHandle, _speedCapInMetersPerSecondHandle, _enableRouteHandleHandle, _enableTrafficOptimizationHandle, _enableTollsHandle, _occupantsNumberHandle, _optimizeWaypointsOrderHandle);
